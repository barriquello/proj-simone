...
#define SNPRINTF_PP(...)	snprintf_lib(__VA_ARGS__)
...
#define SNPRINTF_P(a,b,c,...) 	snprintf_P(a,b,c,__VA_ARGS__)
#define SNPRINTF_PP(a,b,c,...) 	snprintf_P(a,b,(PGM_P)pgm_read_word(&(c)),__VA_ARGS__)
#define VSPRINTF(...)			vsprintf_lib(__VA_ARGS__);
#define VSPRINTF_P(...)			vsprintf_P(a,b,__VA_ARGS__)
#define VSPRINTF_PP(...)		vsprintf_P(a,(PGM_P)pgm_read_word(&(b)),__VA_ARGS__)
...
#define SNPRINTF_PP(...)		snprintf(__VA_ARGS__)
#define VSPRINTF(...)			vsprintf(__VA_ARGS__)
#define VSPRINTF_P(...)			vsprintf(__VA_ARGS__)
#define VSPRINTF_PP(...)		vsprintf(__VA_ARGS__)
