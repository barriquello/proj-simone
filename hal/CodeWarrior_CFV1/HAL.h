...
* \return NONE
*********************************************************************************************/
asm inline __declspec(register_abi) void SaveSP(void)
{  
...
* \return NONE
*********************************************************************************************/
asm inline __declspec(register_abi) void RestoreSP(void)
{  
...
* \return NONE
*********************************************************************************************/
asm inline __declspec(register_abi) void RestoreSR(void)
{  
    MOVE.W   SR,D1
    MOVE.W   26(A7),D0
    ANDI.L   #0x0700,D0    
...
asm inline __declspec(register_abi) void RestoreIntSR(void)
{
    //MOVE.W   D2,SR
    NOP
}
...
asm inline __declspec(register_abi) void Optimezed_Scheduler(void)
{
    FF1 D0
    NEG D0
    ADDI #31,D0
